...
% corrected C3 placement-evidence matrix:
...
% vs external supervision (orange); outlined label = a lever studied in this work.
...
\node[teal!65!black, anchor=north west, align=center, font=\small\itshape] at (6.95,5.7)
  {loss-axis methods};
\node[black!70, align=center, font=\small\itshape] at (9.55,8.3)
...
% ============================================================
\draw[lead] (7.4,0.28)  -- (8.25,0.7);   % focal
\draw[lead] (8.0,2.45)  -- (8.25,1.3);   % class-weighted
\draw[lead] (10.7,2.45) -- (8.75,1.3);   % ohem
\draw[lead] (10.85,0.7) -- (8.75,0.7);   % region-overlap
\draw[lead] (5.1,6.0) -- (3.5,6.0);    % smote
\draw[lead] (5.3,7.25)  -- (3.5,7.25);   % pre-training
\draw[lead] (1.5,9.2)   -- (3.25,8.5);   % tile-level
\draw[lead] (3.75,9.3)   -- (3.75,8.5);   % replication
\draw[lead] (6.0,9.7)   -- (6.0,8.5);    % copy-paste
\draw[lead] (1.3,7.55)  -- (1.5,8.5);    % clsbal sampler (ours)
\draw[lead] (10.1,4.75)  -- (8.5,4.75);   % kd
\draw[lead] (2.5,6.55)  -- (2.5,8.5);    % generative synthesis
...
\node[mkext] at (3.5,7.25) {};  % cross-dataset transfer (Low / Med-High) -- studied lever (label outlined)
\node[mkint] at (1.5,8.5) {};   % clsbal sampler (None-Low / High) -- studied lever (label outlined), pure exposure
...
% ============================================================
\node[lbl] at (7.4,0.28)  {Focal loss};
\node[lbl] at (8.0,2.45)  {Class-weighted /\\re-weighted loss};
\node[lbl] at (10.7,2.45) {Hard-example\\mining};
\node[lbl] at (10.85,0.7) {Region-overlap loss\\(Dice, Tversky,\\Lov\'asz, FC-IoU)};
\node[lbl] at (5.1,6.0) {SMOTE-family\\resampling};
\node[lbl, draw=black!85, line width=0.9pt, inner sep=2.5pt] at (5.3,7.25)  {Cross-dataset\\pre-training};
\node[lbl] at (1.5,9.2)   {Tile-level\\resampling};
\node[lbl] at (3.75,9.3)   {Minority-aware\\replication};
\node[lbl] at (6.0,9.7)   {Copy-paste /\\instance\\augmentation};
\node[lbl, draw=black!85, line width=0.9pt, inner sep=2.5pt] at (1.3,7.55)  {Class-balanced\\sampler};
\node[lbl] at (10.1,4.75)  {Knowledge\\distillation};
\node[lbl] at (2.5,6.55)  {Generative minority\\synthesis};
