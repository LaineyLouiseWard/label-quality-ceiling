...
\draw[decorate,
  ...
  thick, gray!70]
  ([xshift=-9mm]s3a.north west) -- ([xshift=-9mm]s3b.south west)
  node[midway, left=5pt, font=\footnotesize, text=black!70, align=center]
  {Stage\\[-2pt]3};
