# Figure04.py — hard × minority sampling schematic (Stage 4)
# Updated: hard × minority sampling schematic (Stage 4)
...
assert STAGE3B_CKPT.exists(), (
    ...
    "Hardness is computed from this checkpoint (as in scripts/build_stage4_weights.py)."
)
...
assert WEIGHTS_TSV is not None, (
    ...
    + "\nGenerate with:\n"
    "  python scripts/build_stage4_weights.py --ckpt model_weights/biodiversity/stage3b_finetune/stage3b_finetune.ckpt"
)
...
# %%
# Stage 4 weighting hyperparams (MUST match scripts/build_stage4_weights.py defaults)
EPS = 1e-6
...
# %%
def plot_figure04_hard_x_minority_sampling(
    easy_mask, hard_mask,
...
plot_figure04_hard_x_minority_sampling(
    easy_mask, hard_mask,
    easy_hw, easy_mw, easy_final,
    hard_hw, hard_mw, hard_final,
    OUT_PDF
