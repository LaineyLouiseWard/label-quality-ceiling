...
% ── OEM 8-class palette (+ Unknown black) — oem_harmonisation.py OEM8_HEX ──
...
% =====================================================================
% PANEL B — soft teacher distribution (9x6 value-scaled heatmap)
% =====================================================================
...
% Panel-B title. (Reworded: "Soft KD targets" was stale — knowledge distillation is dropped
% from the pipeline. The soft matrix now stands purely as the grounding evidence behind the
% hard argmax routing in (a): the full teacher distribution over Biodiversity classes.)
\node[hdr, anchor=south] at ({\bx+2.5*\cw},{\by+\ch+0.55})
  {(b) Soft teacher distribution: $P(\text{Biodiversity} \mid \text{teacher OEM}) \times 100$};
