#!/usr/bin/env python3
"""
scripts/figures/fig_iou_vs_stage.py
...
Outputs:
  figures/fig_iou_vs_stage.pdf
  figures/fig_iou_vs_stage.png
"""
...
OUT_PDF = OUT_DIR / "fig_iou_vs_stage.pdf"
OUT_PNG = OUT_DIR / "fig_iou_vs_stage.png"
...
STAGES: List[Tuple[str, str]] = [
    ...
    ("3b", "stage3b_finetune"),
    ("4", "stage4_sampling"),
    ("5", "stage6_kd"),  # folder name in your repo appears to be stage6_kd
]
...
# -----------------------
# Fallback: Table 2 values (already in %)
# (Keys are converted to match CLASSES so colours/labels remain correct.)
# -----------------------
TABLE2_FALLBACK: Dict[str, Dict[str, float]] = {
    "1":  {"Forest land": 71.7, "Grassland": 90.0, "Cropland": 79.9, "Settlement": 67.9, "Semi-nat.": 58.6},
    "2":  {"Forest land": 73.0, "Grassland": 91.0, "Cropland": 82.9, "Settlement": 68.5, "Semi-nat.": 67.2},
    "3b": {"Forest land": 74.7, "Grassland": 92.0, "Cropland": 89.1, "Settlement": 72.6, "Semi-nat.": 69.5},
    "4":  {"Forest land": 75.4, "Grassland": 92.3, "Cropland": 88.2, "Settlement": 74.7, "Semi-nat.": 74.0},
    "5":  {"Forest land": 76.7, "Grassland": 93.3, "Cropland": 88.4, "Settlement": 76.6, "Semi-nat.": 81.4},
}
...
if __name__ == "__main__":
    try:
        ...
        print("WARNING: Falling back to Table 2 values.")
        print("Reason:", repr(e))
        stage_to_iou = {s: TABLE2_FALLBACK[s] for s, _ in STAGES if s in TABLE2_FALLBACK}
