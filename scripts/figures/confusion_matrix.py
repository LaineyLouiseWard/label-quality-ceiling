...
CM_C = repo_root / "evaluation/evaluation_results/val/stage6_kd/stage6_kd/confusion_matrix.npy"

OUT_DIR = repo_root / "figures"
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT_PDF = OUT_DIR / "fig_confusion_matrix_stage1_vs_stage4_vs_stage6kd.pdf"
...
def main():
    ...
    # IMPORTANT: label as Stage 5 in the paper, even if file path is stage6_kd
