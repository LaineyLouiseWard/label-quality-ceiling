...
python -m scripts.figures.fig6a_comparison \
  ...
  --stage5-ckpt   model_weights/biodiversity/stage5_final_kd_ftunetformer \
...
def main() -> None:
    ...
    ap.add_argument(
        "--stage5-ckpt",
        type=str,
        default="model_weights/biodiversity/stage5_final_kd_ftunetformer",
    ...
    s6_ckpt = resolve_ckpt(str((repo_root / args.stage5_ckpt).resolve()))
